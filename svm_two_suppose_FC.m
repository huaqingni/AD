function [train_h0_data, train_h0_label, train_h1_data, train_h1_label, test_h0_label, test_h1_label,testlabel]=svm_two_suppose_FC(index, data_name)
...
if (Ytemp(index)==2|Ytemp(index)==3)
    testlabel=1
end
if Ytemp(index)==0
    testlabel=0
