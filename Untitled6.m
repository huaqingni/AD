...
testlabel=Y(index);
Y(find(Y~=0))=1;
[ranking0,train_h0_data, train_h0_label, test_h0_label] = train_h0(index, X, Y, selection_method, 0);

[train_h0_data, train_h0_label] = energy_normalization(train_h0_data, train_h0_label);

[ranking1,train_h1_data, train_h1_label, test_h1_label] = train_h0(index, X, Y, selection_method,1);
rank=[ranking0;ranking1];
...
function [ranking,train_h0_data, train_h0_label,  test_h0_label] = train_h0(index, X, Y, selection_method,tag)
